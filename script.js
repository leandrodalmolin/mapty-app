...
class Running extends Workout {
    type = 'running'; // same as adding "this.type = 'running'" to the constructor
...
class App {
    ...
    _loadMap(position) {
        ...
        // Renders workouts on local storage after map is loaded
    ...
    _newWorkout(e) {
        ...
        const distance = +inputDistance.value; // plus converts to number
        const duration = +inputDuration.value; // plus converts to number
